...
class PreguntasActivityViewModel : ViewModel() {

    //////////////////////////PERSONALIZADO//////////////////////////////
    var listado1 = GameStateProvider.europaPaises
    var listado2 = GameStateProvider.europaCapitales
    val TOPE = GameStateProvider.TAMANOEUROPA
    //////////////////////////////////////////////////////////////////////
    ...
    fun crearListadoParaOpciones(indice: Int): MutableList<String>{
        ...
        var opc1 = GameStateProvider.todosCapitales.get(Random.nextInt(GameStateProvider.todosCapitales.size))
        while(listadoParaOpciones.contains(opc1)){
            opc1 = GameStateProvider.todosCapitales.get(Random.nextInt(GameStateProvider.todosCapitales.size))
        }
        listadoParaOpciones.add(opc1)
        var opc2 = GameStateProvider.todosCapitales.get(Random.nextInt(GameStateProvider.todosCapitales.size))
        while(listadoParaOpciones.contains(opc2)){
            opc2 = GameStateProvider.todosCapitales.get(Random.nextInt(GameStateProvider.todosCapitales.size))
        }
