...
class TodosPModel: ViewModel() {
    //////////////////////////PERSONALIZADO//////////////////////////////
    var listado1 = GameStateProvider.todosPaises
    var listado2 = GameStateProvider.todosCapitales
    val TOPE = GameStateProvider.TAMANOTODOS
    //////////////////////////////////////////////////////////////////////
    ...
    fun crearListadoParaOpciones(indice: Int): MutableList<String>{
        ...
        var opc1 = GameStateProvider.todosCapitalesReferencia.get(Random.nextInt(GameStateProvider.todosCapitalesReferencia.size))
        while(listadoParaOpciones.contains(opc1)){
            opc1 = GameStateProvider.todosCapitalesReferencia.get(Random.nextInt(GameStateProvider.todosCapitalesReferencia.size))
        }
        listadoParaOpciones.add(opc1)
        var opc2 = GameStateProvider.todosCapitalesReferencia.get(Random.nextInt(GameStateProvider.todosCapitalesReferencia.size))
        while(listadoParaOpciones.contains(opc2)){
            opc2 = GameStateProvider.todosCapitalesReferencia.get(Random.nextInt(GameStateProvider.todosCapitalesReferencia.size))
        }
