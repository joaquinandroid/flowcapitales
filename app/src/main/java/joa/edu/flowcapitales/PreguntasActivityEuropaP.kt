...
class PreguntasActivityEuropaP : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: ActivityPreguntasActiviyBinding
    private lateinit var viewModel: PreguntasActivityViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(PreguntasActivityViewModel::class.java)
