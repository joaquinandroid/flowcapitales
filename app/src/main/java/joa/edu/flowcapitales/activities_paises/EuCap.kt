...
import joa.edu.flowcapitales.PreguntasActivityViewModel
...
class EuCap : AppCompatActivity(), View.OnClickListener {
    private lateinit var binding: ActivityPreguntasActiviyBinding
    private lateinit var viewModel: EuCapModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(EuCapModel::class.java)
