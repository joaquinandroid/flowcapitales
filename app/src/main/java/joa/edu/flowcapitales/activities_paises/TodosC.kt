...
import joa.edu.flowcapitales.models_paises.TodosCModel

class TodosC : AppCompatActivity(), View.OnClickListener {
    private lateinit var binding: ActivityPreguntasActiviyBinding
    private lateinit var viewModel: TodosCModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(TodosCModel::class.java)
