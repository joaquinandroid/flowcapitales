...
import joa.edu.flowcapitales.models_paises.AfricaPModel
import joa.edu.flowcapitales.models_paises.EuCapModel

class AfricaP : AppCompatActivity(), View.OnClickListener {
    private lateinit var binding: ActivityPreguntasActiviyBinding
    private lateinit var viewModel: AfricaPModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(AfricaPModel::class.java)
