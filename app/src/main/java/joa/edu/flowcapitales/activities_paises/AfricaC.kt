...
import joa.edu.flowcapitales.models_paises.AfricaCModel
import joa.edu.flowcapitales.models_paises.EuCapModel

class AfricaC : AppCompatActivity(), View.OnClickListener {
    private lateinit var binding: ActivityPreguntasActiviyBinding
    private lateinit var viewModel: AfricaCModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(AfricaCModel::class.java)
