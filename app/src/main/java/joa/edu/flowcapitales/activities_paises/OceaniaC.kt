...
import joa.edu.flowcapitales.models_paises.OceaniaCModel

class OceaniaC : AppCompatActivity(), View.OnClickListener {
    private lateinit var binding: ActivityPreguntasActiviyBinding
    private lateinit var viewModel: OceaniaCModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(OceaniaCModel::class.java)
