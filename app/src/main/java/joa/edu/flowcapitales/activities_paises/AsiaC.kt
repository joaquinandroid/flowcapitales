...
import joa.edu.flowcapitales.models_paises.AsiaCModel
import joa.edu.flowcapitales.models_paises.AsiaModel
import joa.edu.flowcapitales.models_paises.EuCapModel

class AsiaC : AppCompatActivity(), View.OnClickListener {
    private lateinit var binding: ActivityPreguntasActiviyBinding
    private lateinit var viewModel: AsiaCModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(AsiaCModel::class.java)
