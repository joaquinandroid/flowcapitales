...
import joa.edu.flowcapitales.models_paises.OceaniaPModel

class OceaniaP : AppCompatActivity(), View.OnClickListener {
    private lateinit var binding: ActivityPreguntasActiviyBinding
    private lateinit var viewModel: OceaniaPModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(OceaniaPModel::class.java)
